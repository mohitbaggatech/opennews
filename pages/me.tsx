...
export default function MyData() {
    ...
    return (
        <>
        <h3 className="font-medium leading-tight text-3xl mb-2 text-blue-600 mt-6">My Profile</h3>
...
export function MyAnnotations() {
    ...
    const fetchAnnotationsList = async () => {
        ...
        if (program && wallet) {
            ...
            const annotations = await fetchAnnotations({
                program,
                filter: [
                    annotationAuthorFilter(wallet.publicKey)
                ]
            });
    ...
    const sortedAnnotations = orderBy(annotations, ["timestamp"]);
                        ...
                        (
                            <div className="flex justify-center">
                                <div className="block p-6 rounded-lg shadow-lg max-w-sm">
                                    <h5 className="text-xl leading-tight font-medium mb-2">Wallet Not Connected</h5>
                                    <p className="text-base mb-4">
                                        Connect your wallet to see your past annotations or to create new.
                                    </p>
...
const MyAnnotationCard = ({ content, topic, onEdit }: any) => {
    ...
    return (
        ...
        <div className="group w-full" id={`my_annotation_${content.key}`}>
            ...
            <div className="flex">
                <div className="w-2/12 pr-7 pb-10 mt-1">
                ...
                <div className={`border-l-2 ${content.snippet_type == 0 ? "border-violet-300" : content.snippet_type == 1 ? "border-emerald-300" : "border-rose-300"} pb-10 pl-5`}>
                    ...
                    <div className='flex items-center border-b border-gray-300 pb-3 pt-3 dark:border-gray-700 '>
                                <svg className='w-4 h-4 mr-2 dark:fill-gray-500' viewBox="72.249 94.929 326.585 308.221" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href={`https://explorer.solana.com/address/${content.key}/instructions?cluster=devnet`} target={"_blank"} rel="noreferrer" className='hover:text-blue-700 text-blue-400 text-sm'>{content.key}</a>
...
function MyTopics() {
    ...
    const fetchTopicsList = async () => {
        ...
        if (program && wallet) {
            ...
            const topics = await fetchTopics({
                program,
                filter: [
                    topicAuthorFilter(wallet.publicKey)
                ]
            });
    ...
    return (
        <div className="w-full pr-10 pt-5">
            {
                wallet ?
                    isLoading ?
                        (
                        ...
                        (
                            <>
                                ...
                                <div className="flex justify-center items-center">
                                    <div className="collapse mb-10 card max-w-md p-4 shadow-lg rounded-lg pt-6" id="addTopicCollapse">
                                        <h2>
                                            Add New Topic
                                        </h2>
                                ...
                                {isAddTopicLoading ?
                                    ...
                                    <div className="flex justify-center mt-10">
                                        <div className="max-w-md">
                                            <AddedTopicWidget onAddNew={() => { }} addedTopic={addedTopic} />
                                        </div>
                                    </div>
                                }
                                {sortedTopics.length == 0 ?
                                    ...
                                    : sortedTopics.map((t: any) => (
                                        <div className='mt-5 pb-5 ' key={`mytopic${t.publicKey}`}>
                                            <TopicCard content={t} />
                                        </div>))}
                            </>)
                    :
                    (
                        <div className="flex justify-center w-full">
                            <div className="block p-6 rounded-lg shadow-lg max-w-sm dark:border-1-gray-200">
                                <h5 className="text-xl leading-tight font-medium mb-2">Wallet Not Connected</h5>
                                <p className="text-base mb-4">
                                    Connect your wallet to see your past annotations or to create new.
                                </p>
    ...
    return (
        ...
        <div className="group w-full">
            ...
            <div className="flex">
                ...
                {/* ${content.snippet_type == 0 ? "group-hover:bg-violet-50" : content.snippet_type == 1 ? "group-hover:bg-emerald-50" : "group-hover:bg-rose-50"}  */}
                <div className={`border-l-2 border-blue-300 pb-10 pl-5`}>

                    <div className="flex">
                        <button type="button" className={`bg-blue-400 -ml-9 inline-block rounded-full text-white leading-normal uppercase shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-8 h-8 `}>
                            <div>
